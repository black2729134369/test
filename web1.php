...
<head>
	<meta charset="utf-8">
	<title>北京时代壹佰科技有限公司-建设管理系统</title>
    ...
    <div class="swiper-wrapper">
        	...
        	<div class="swiper-slide">
        		...
        		<div class="container">
			    	<div class="position-absolute text-light" style="top:30%;">
						<h1 class="fs-20 fs-sm-32 wow slideInUp">PbootCMS</h1>
					 	<h4 class="fs-14 fs-sm-20 wow slideInUp">高效、简洁、强悍的PHP建站源码</h4>
					</div>
			    </div>
        	</div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-3 wow zoomIn" data-wow-delay="100ms" data-wow-duration="1s">
              <div class="card">
                  <div class="card-img-150"><a href="/?domain/13.html"><img class="card-img-top" src="/static/upload/image/20180412/1523499979727269.jpg" alt="网站空间"></a></div>
                  <div class="card-body">
                    <h5 class="card-title"><a href="/?domain/13.html">网站空间</a></h5>
                    <p class="card-text">
        ...
        <div class="col-12 col-sm-6 col-lg-3 wow zoomIn" data-wow-delay="300ms" data-wow-duration="1s">
              <div class="card">
                  <div class="card-img-150"><a href="/?website/11.html"><img class="card-img-top" src="/static/upload/image/20180412/1523501297516241.jpg" alt="网站建设专业版"></a></div>
                  <div class="card-body">
                    <h5 class="card-title"><a href="/?website/11.html">网站建设专业版</a></h5>
                    <p class="card-text">
    ...
    <div class="container">
      ...
      <div class="row">
            ...
            <div class="col-12 col-lg-6 mb-3 wow fadeInUp" data-wow-delay="500ms">
                <div class="media mb-3">
                  <div class="media-body">
                     <h5><a href="/?company/4.html" title="PbootCMSV1.0.0正式发布">PbootCMSV1.0.0正式发布</a></h5>
                     <p><a href="/?company/4.html" class="text-secondary lh-2"> PbootCMS是全新内核且永久开源免费的PHP企业网站开发建设管理系统，是一套高效、简洁、 强悍的可免费商用的PHP CMS源码，能够满··· 2018-04-12</a></p>
                  </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 mb-3 wow fadeInUp" data-wow-delay="500ms">
                <div class="media mb-3">
                  <div class="media-body">
                     <h5><a href="/?company/8.html" title="PbootCMS主要功能介绍">PbootCMS主要功能介绍</a></h5>
                     <p><a href="/?company/8.html" class="text-secondary lh-2">PbootCMS是全新内核且永久开源免费的PHP企业网站开发建设管理系统，是一套高效、简洁、 强悍的可免费商用的PHP CMS源码，能够满足··· 2018-04-12</a></p>
                  </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 mb-3 wow fadeInUp" data-wow-delay="500ms">
                <div class="media mb-3">
                  <div class="media-body">
                     <h5><a href="/?industry/7.html" title="大获全胜 扎克伯格如何赢得与议员的当面对峙">大获全胜 扎克伯格如何赢得与议员的当面对峙···</a></h5>
                     <p><a href="/?industry/7.html" class="text-secondary lh-2">腾讯《深网》 纪振宇 4月11日发自硅谷并不是扎克伯格表现地多好，而是议员们的表现太差了。在经历了连续两天马拉松式的国会议员“··· 2018-04-12</a></p>
                  </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 mb-3 wow fadeInUp" data-wow-delay="500ms">
                <div class="media mb-3">
                  <div class="media-body">
                     <h5><a href="/?industry/6.html" title="锤子6年了 我们找到了它没有死的秘密">锤子6年了 我们找到了它没有死的秘密</a></h5>
                     <p><a href="/?industry/6.html" class="text-secondary lh-2">他有些戏谑意味地取了“锤子”这个名字。此前抡锤砸西门子冰箱的“壮举”让他一举成名，他想在手机圈里也搞出类似的动静来。这似··· 2018-04-12</a></p>
                  </div>
                </div>
            </div>
	...
	<div class="container">
    	<div class="row pb-5">
            <div class="col-12 col-md-5">
                ...
                <ul class="lh-2">
                	<li>营业执照：  </li>
                    <li>备案号码：<a href="http://beian.miit.gov.cn/" target="_blank">京ICP备16023256号</a> </li>
                    <li>地址：北京市怀柔区怀沙路536号 </li>
                </ul>
            </div>
            <div class="col-12 col-md-5">
            	...
            	<h5>联系我们</h5>
                <ul class="lh-2">
                    <li>电话：010-88886666 </li>
                    <li>邮箱：admin@pbootcms.com </li>
                    <li>Q&nbsp;&nbsp;Q：88886666 </li>
                </ul>
            </div>
            <div class="col-12 col-md-2 text-center d-none d-md-block">
            	<p class="code"><img src="/core/qrcode.php?string=http%3A%2F%2Ftimestoebay.com%2F" class="qrcode" alt="二维码"> </p>
                <p class="small">扫一扫 手机访问</p>
            </div>
        </div>
	</div>
    <div class="copyright border-top lh-3 text-center  d-none d-md-block">
    	Copyright © 2018-2023 北京时代壹佰科技有限公司  <a href="https://beian.miit.gov.cn/#/Integrated/index"> 京ICP备16023256号 </a>  All Rights Reserved.
    </div>
</div>
